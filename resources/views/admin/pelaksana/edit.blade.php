<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Edit Data Pelaksana: ') }} {{ $pelaksana->nama_perusahaan }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.pelaksana.update', $pelaksana) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <x-text-input id="nama_perusahaan" class="block mt-1 w-full" type="text"
                                name="nama_perusahaan" :value="old('nama_perusahaan', $pelaksana->nama_perusahaan)" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="nama_kontak" class="block mt-1 w-full" type="text" name="nama_kontak"
                                :value="old('nama_kontak', $pelaksana->nama_kontak)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email"
                                :value="old('email', $pelaksana->user->email)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="telepon" class="block mt-1 w-full" type="text" name="telepon"
                                :value="old('telepon', $pelaksana->telepon)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="alamat" name="alamat"
                                ...
                                required>{{ old('alamat', $pelaksana->alamat) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nomor_kontrak" class="block mt-1 w-full" type="text"
                                    name="nomor_kontrak" :value="old('nomor_kontrak', $pelaksana->nomor_kontrak)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_kontrak" class="block mt-1 w-full" type="date"
                                    name="tanggal_kontrak" :value="old('tanggal_kontrak', $pelaksana->tanggal_kontrak)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_bank" class="block mt-1 w-full" type="text" name="nama_bank"
                                    :value="old('nama_bank', $pelaksana->nama_bank)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="nomor_rekening" class="block mt-1 w-full" type="text"
                                    name="nomor_rekening" :value="old('nomor_rekening', $pelaksana->nomor_rekening)" />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="atas_nama_rekening" class="block mt-1 w-full" type="text"
                                    name="atas_nama_rekening" :value="old('atas_nama_rekening', $pelaksana->atas_nama_rekening)" />
